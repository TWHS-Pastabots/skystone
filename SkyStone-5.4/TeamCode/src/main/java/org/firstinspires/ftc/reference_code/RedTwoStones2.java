...
@Autonomous
@Disabled
public class RedTwoStones2 extends PositionBasedAuton2 {
    ...
    public void drive(){
        ...
        if(getStoneConfig().equals("Right")){

            driveToPosition(-13.0, 32.0, DRIVE_SPEED, 90, 0.0, true, 10, positioning, sensing);
            ...
            driveToPosition(-17.0, 20.0, DRIVE_SPEED, 90, 0.0, true, 10, positioning, sensing);
            turn(-90.0, TURN_SPEED, positioning);
            ...
            //Drive back towards the wall, drive to the platform, turn to face it, drop the block onto it, then turn back to face the quarry
            driveToPosition( -49, 32.0, 0.5, -90, 0.0, true, 10, positioning, sensing);
            driveToPosition( 24, 32.0, DRIVE_SPEED, -90, 0.0, true, 10, positioning, sensing);
            turn(0.0, TURN_SPEED, positioning);
            sensing.activateOuttake();
            sleep(2000);
            ...
            driveToPosition(-25.0, 20.0, DRIVE_SPEED, 90, 0.0, true, 10, positioning, sensing);
            turn(-90.0, TURN_SPEED, positioning);
