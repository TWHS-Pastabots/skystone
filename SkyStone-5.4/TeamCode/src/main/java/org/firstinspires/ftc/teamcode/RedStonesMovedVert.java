...
@Autonomous
public class RedStonesMovedVert extends PositionBasedAuton4 {
    ...
    public void drive(){
        ...
        if(getStoneConfig().equals("Middle")){
            ...
            driveToPosition( 43, 32.0, 0.75, -90, 0.0, 15, 6, positioning, sensing);
            sensing.dropBlock();
            ...
            driveToPosition( 43, 32.0, 0.75, -90, 0.0, 20, 10, positioning, sensing);
            sensing.dropBlock();
            while(!sensing.isBlockDropped()){
                telemetry.addData("Status:", "Dropping Block");
                telemetry.update();
            ...
            //correctPosition(false, true, positioning);
            driveToPosition( 0, 32.0, 0.4, -90, 0.0, 0, 10, positioning, sensing);
            ...
            //correctPosition(false, true, positioning);
            driveToPosition( 43, 32.0, 0.75, -90, 0.0, 15, 10, positioning, sensing);
            sensing.dropBlock();
            while(!sensing.isBlockDropped()){
                telemetry.addData("Status:", "Dropping Block");
                telemetry.update();
            ...
            sensing.activateIntake();
            driveToPosition(-23.0, 42.0, 0.50, -45, 0.0, 0, 10, positioning, sensing);
