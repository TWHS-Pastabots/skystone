...
@Autonomous
public class BlueStonesMovedVert extends PositionBasedAuton4 {
    ...
    public void drive(){
        ...
        if(getStoneConfig().equals("Middle")){
            ...
            //correctPosition(false, true, positioning);
            driveToPosition( 0, 34.0, 0.4, 90, 0.0, 0, 10, positioning, sensing);
            ...
            sensing.activateIntake();
            driveToPosition(22.0, 41.0, 0.50, 45, 0.0, 0, 10, positioning, sensing);
