...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    public OdometryGlobalCoordinatePosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
        this.encoder_left = verticalEncoderLeft;
        this.encoder_right = verticalEncoderRight;
        this.encoder_horizontal = horizontalEncoder;
    ...
    private void globalCoordinatePositionUpdate(){
        ...
        verticalLeftEncoderWheelPosition = (encoder_left.getCurrentPosition() * verticalLeftEncoderPositionMultiplier);
        verticalRightEncoderWheelPosition = (encoder_right.getCurrentPosition() * verticalRightEncoderPositionMultiplier);
        ...
        normalEncoderWheelPosition = (encoder_horizontal.getCurrentPosition()*normalEncoderPositionMultiplier);
