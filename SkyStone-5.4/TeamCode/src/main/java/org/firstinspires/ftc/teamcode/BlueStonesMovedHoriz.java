...
@Autonomous
public class BlueStonesMovedHoriz extends PositionBasedAuton4 {
    ...
    public void drive(){
        ...
        if(getStoneConfig().equals("Middle")){
            ...
            driveToPosition(23.0, 48.0, 0.50, 90, 0.0, 0, 10, positioning, sensing);
            ...
            sensing.activateIntake();
            driveToPosition(30.0, 48.0, 0.50, 90, 0.0, 0, 10, positioning, sensing);
            //correctPosition(true, true, positioning);

            //Drive back towards the wall, drive to the platform, turn to face it, drop the block onto it, then turn back to face the quarry
            driveToPosition( 30, 32.0, 0.5, 90, 0.0, 5, 10, positioning, sensing);
            //correctPosition(false, true, positioning);
            driveToPosition( -25, 32.0, 0.75, 90, 0.0, 15, 10, positioning, sensing);
            driveToPosition( -25, 21.0, 0.4, 90, 0.0, 0, 10, positioning, sensing);
            sensing.dropBlock();
            ...
            sensing.activateIntake();
            driveToPosition( 55, 47.0, 0.4, 90, 0.0, 0, 10, positioning, sensing);
            //correctPosition(true, true, positioning);
            driveToPosition( 55, 32.0, 0.5, 90, 0.0, 5, 10, positioning, sensing);
            driveToPosition( -25, 32.0, 0.75, 90, 0.0, 20, 10, positioning, sensing);
            driveToPosition( -25, 28.0, 0.75, 90, 0.0, 20, 10, positioning, sensing);
            sensing.dropBlock();
            while(!sensing.isBlockDropped()){
        ...
        else if(getStoneConfig().equals("Left")){
            ...
            sensing.activateIntake();
            driveToPosition(21.0, 40.0, 0.50, 45, 0.0, 0, 10, positioning, sensing);
            //turn(-90, TURN_SPEED, positioning);
            //correctPosition(true, true, positioning);

            //Drive back towards the wall, drive to the platform, turn to face it, drop the block onto it, then turn back to face the quarry
            driveToPosition( 20, 32.0, 0.5, 90, 0.0, 5, 10, positioning, sensing);
            //correctPosition(false, true, positioning);
            driveToPosition( -25, 32.0, 0.75, 90, 0.0, 15, 10, positioning, sensing);
            driveToPosition( -25, 21.0, 0.4, 90, 0.0, 0, 10, positioning, sensing);
            sensing.dropBlock();
            ...
            sensing.activateIntake();
            driveToPosition( 39, 47.0, 0.4, 90, 0.0, 0, 10, positioning, sensing);
            //correctPosition(true, true, positioning);
            driveToPosition( 39, 32.0, 0.5, 90, 0.0, 5, 10, positioning, sensing);
            driveToPosition( -25, 32.0, 0.75, 90, 0.0, 20, 10, positioning, sensing);
            driveToPosition( -25, 28.0, 0.75, 90, 0.0, 20, 10, positioning, sensing);
            sensing.dropBlock();
            while(!sensing.isBlockDropped()){
