...
@Autonomous
@Disabled
public class AutonBlueOneBlockDrag extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDriveCenter(DRIVE_SPEED, 20, 10.0, false);

        gyroDrive(DRIVE_SPEED, 34.0, 0.0, false);

        gyroTurn(TURN_SPEED, -90.0);

        gyroDrive(DRIVE_SPEED, 8.0, -90, false);
