...
public class VisionTestOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        final float CAMERA_VERTICAL_DISPLACEMENT = 10.5f * mmPerInch;   // eg: Camera is 10.5 Inches above ground
        final float CAMERA_LEFT_DISPLACEMENT     = -6.5f * mmPerInch;     // eg: Camera is 6.5 inches right on the robot
        ...
        while (opModeIsActive()) {
            ...
            //The normal drive code from here down
            double leftPower;
            double rightPower;
            double centerPower;
