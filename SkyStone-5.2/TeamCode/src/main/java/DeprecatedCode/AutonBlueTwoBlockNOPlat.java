...
@Autonomous
@Disabled
public class AutonBlueTwoBlockNOPlat extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroDrive(DRIVE_SPEED, 34.0, 0, true);
        ...
        //Drive backward to quarry
        gyroDrive(1.0, -60, 90, true);

        //Turn 90d left to face blocks
        gyroTurn(TURN_SPEED, 0.0, 3.0);

        //Drive forward to block
        gyroDrive(DRIVE_SPEED, 8.0, 0, false);
