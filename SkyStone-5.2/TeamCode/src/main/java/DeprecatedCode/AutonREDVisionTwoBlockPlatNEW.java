...
@Autonomous
@Disabled
public class AutonREDVisionTwoBlockPlatNEW extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(stoneConfig.equals("Left")){
            ...
            gyroDriveCenter(DRIVE_SPEED, 0.6, 62, 1.2, 0, true);
        }
        else{
        ...
        //Turn 90d right to face delivery area
        ...
        //Turn 90d left to face platform
        ...
        //Turn 90d to the left to face back to quarry
        gyroTurn(TURN_SPEED, 90.0, 2.0);
        ...
        if(stoneConfig.equals("Middle")){
            ...
            gyroDrive(DRIVE_SPEED, 60, 90, true, 10.0);
        }
        else{
        ...
        if(!(stoneConfig.equals("Left"))) {
            ...
            if (stoneConfig.equals("Right")) {
                gyroDrive(DRIVE_SPEED, 115, -90, true, 3.0);
            } else if (stoneConfig.equals("Middle")) {
                gyroDrive(DRIVE_SPEED, 125, -90, true, 3.0);
            } else if (stoneConfig.equals("Left")) {
                gyroDrive(DRIVE_SPEED, 60, -90, true, 3.0);
            }
