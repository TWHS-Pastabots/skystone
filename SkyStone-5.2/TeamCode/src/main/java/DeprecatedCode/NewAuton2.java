...
@Autonomous
@Disabled
public class NewAuton2 extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       // allTrackables.addAll(targetsSkyStone);
        ...
        double stoneMiddle = -1;
        String  skystoneLoc = "";
        double detectionTimer = runtime.seconds();
                ...
                if (updatedRecognitions != null) {
                    for (Recognition recognition : updatedRecognitions) {
                        if (recognition.getLabel().equals(LABEL_SKYSTONE))
                            stoneMiddle = (recognition.getLeft() + recognition.getRight()) / 2.0;
                    }
                }
                if(runtime.seconds()-detectionTimer > 5.0){
                    stoneMiddle = -2;
                    break;
                }
            }
        ...
        if(stoneMiddle == -2)
            skystoneLoc = "Right";
        else if(stoneMiddle < 600)
            skystoneLoc = "Left";
        else if(stoneMiddle >= 600)
            skystoneLoc = "Middle";

        if(skystoneLoc.equals("Left")){
            encoderDriveCenter(0.3, 2.5, 2.0, false);
        }
        else if(skystoneLoc.equals("Middle")){
            encoderDriveCenter(0.3, 10.5, 4.0, false);
        }
        else if(skystoneLoc.equals("Right")){
            encoderDriveCenter(0.3, 18.5, 8.0, false);
        }
        ...
        if(skystoneLoc.equals("Left")){
            gyroDrive(DRIVE_SPEED, 88, 90);
        }
        else if(skystoneLoc.equals("Middle")){
            gyroDrive(DRIVE_SPEED, 96, 90);
        }
        else if(skystoneLoc.equals("Right")){
            gyroDrive(DRIVE_SPEED, 104, 90);
        }
        ...
        if(skystoneLoc.equals("Left")){
            gyroDrive(DRIVE_SPEED, 112, -90);
        }
        else if(skystoneLoc.equals("Middle")){
            gyroDrive(DRIVE_SPEED, 120, -90);
        }
        else if(skystoneLoc.equals("Right")){
            gyroDrive(DRIVE_SPEED, 88, -90);
        }
        ...
        gyroDrive(DRIVE_SPEED, -32.0, 0.0);
