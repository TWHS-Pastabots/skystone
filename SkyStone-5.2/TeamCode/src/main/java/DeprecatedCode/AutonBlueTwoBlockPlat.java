...
@Autonomous
@Disabled
public class AutonBlueTwoBlockPlat extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroDrive(DRIVE_SPEED, 33.0, 0, true);
        ...
        //Drag block back
        gyroDrive(DRIVE_SPEED, -5.0, 0, false);
        ...
        gyroDrive(DRIVE_SPEED, -3.0, 0.0, false);

        //Turn 90d to the right to face back to quarry
        gyroTurn(TURN_SPEED, -90.0, 3.0);

        //Drive forward to quarry
        gyroDrive(1.0, 90.5, -90, true);

        //Turn 90d left to face blocks
        gyroTurn(TURN_SPEED, 0.0, 3.0);

        //Drive forward to block
        gyroDrive(DRIVE_SPEED, 10.0, 0, false);
        ...
        gyroDrive(DRIVE_SPEED, -20, 90, true);
