...
@Autonomous
@Disabled
public class AutonBlueTwoBlockPlatNEW extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyroDrive(DRIVE_SPEED, 29.0, 0, true);
        ...
        //Drag block back
        gyroDrive(DRIVE_SPEED, -4.0, 0, false);
        ...
        gyroDrive(DRIVE_SPEED, -10.0, 90, true);
