...
@Autonomous
@Disabled
public class AutonTestOutNoReset extends LinearOpMode {
    ...
    static final double     HEX120_COUNTS_PER_MOTOR_REV    = 560; //THIS CHANGED
    ...
    public void runOpMode() {
        ...
        gyroDrive(DRIVE_SPEED, 11.131662696,0, false,30.0);

        //Drive backward one full wheel rotation
        gyroDrive(DRIVE_SPEED, -11.131662696,0, false,30.0);
    ...
    private void gyroDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            if(motor_left.getCurrentPosition() - newLeftTarget >= 0)
                while   ( opModeIsActive()                                   &&
                        ( (motor_left.getCurrentPosition() - newLeftTarget) > 0  ) &&
                        ( (motor_right.getCurrentPosition() - newRightTarget) > 0 ) &&
                    ...
                    //Give the motors the final calculated power
