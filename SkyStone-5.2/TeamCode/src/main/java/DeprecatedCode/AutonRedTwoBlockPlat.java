...
public class AutonRedTwoBlockPlat extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        motor_cup = hardwareMap.get(DcMotor.class, "motor_cup");
        ...
        gyroDrive(DRIVE_SPEED, 33.0, 0, true, 10.0);
        ...
        gyroDrive(DRIVE_SPEED, -3.0, 0.0, false, 10.0);

        //Turn 90d to the left to face back to quarry
        gyroTurn(TURN_SPEED, 90.0, 3.0);

        //Drive forward to quarry
        gyroDrive(1.0, 90.5, 90, true, 10.0);

        //Turn 90d right to face blocks
        gyroTurn(TURN_SPEED, 0.0, 3.0);

        //Drive forward to block
        gyroDrive(DRIVE_SPEED, 10.0, 0, false, 10.0);
        ...
        gyroDrive(DRIVE_SPEED, -20, -90, true, 10.0);
